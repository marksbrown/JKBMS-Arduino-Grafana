...
int loop() {
    ...
    if (bms.isDataValid()) {
        ...
        InsertRequest["sql"] = "INSERT INTO " + String(SECRET_DBTABLE) + "(date,voltage,current,soc,cycles,power_temp,battery_temp,cell0_voltage,cell1_voltage,cell2_voltage,cell3_voltage,cell_voltage_delta,charging_enabled,discharging_enabled,ischarging,isdischarging) VALUES (CURRENT_TIMESTAMP," + String(bms.getVoltage()) + "," + String(bms.getCurrent()) + "," + String(bms.getSOC()) + "," + String(bms.getCycles()) + "," + String(bms.getPowerTemp()) + "," + String(bms.getBatteryTemp()) + "," + String(bms.getCellVoltage(0)) + "," + String(bms.getCellVoltage(1)) + "," + String(bms.getCellVoltage(2)) + "," + String(bms.getCellVoltage(3)) + "," + String(bms.getCellVoltageDelta()) + "," + String(bms.isChargingEnabled()) + "," + String(bms.isDischargingEnabled()) + "," + String(bms.isCharging()) + "," + String(bms.isDischarging()) + ");";
